                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className='container mt-4'>
                                                <div class="row align-items-center justify-content-between">
                                                    <div class="col-2">
                                                        <div class="noti-profile">SK</div>
                                                    </div>
                                                    <div className='col-10'>
                                                        <div class="d-flex align-items-center justify-content-between ongoing-card-cont">
                                                            <h6 class="col-3">Name </h6>
                                                            <h6 class="card-text">: </h6>
                                                            <h6 class="col-7">{this.side.delivery_det.name}</h6>
                                                        </div>
                                                        <div class="d-flex align-items-center justify-content-between ongoing-card-cont">
                                                            <h6 class="col-3">Phone No </h6>
                                                            <h6 class="card-text">: </h6>
                                                            <h6 class="col-7">{this.side.delivery_det.phone_no}</h6>
                                                        </div>
                                                        <div class="d-flex align-items-center justify-content-between ongoing-card-cont">
                                                            <h6 class="col-3">Price </h6>
                                                            <h6 class="card-text">: </h6>
                                                            <h6 class="col-7">₹2294</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
